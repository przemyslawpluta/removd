...
describe('# base64 workflow service API', () => {
    ...
    // context('with text source, same destination a 5k image and size autodetected set with person and saved as image but resolution preserved', () => {
    ...
    // context('with text source, same destination a 5k image and size autodetected set with person but resolution preserved', () => {
    ...
    // context('with url data source, same destination a 5k image and size autodetected set with person but resolution preserved', () => {
